        ...
        <section className="px-28 py-16">
          <div className="grid grid-cols-2 py-12">
            <article>
              ...
              <h2 className="text-3xl text-red-800 font-light mt-36">
          ...
          <div className="flex my-24 relative">
            <figure className="w-[660px]">
              <img src={sectionTwoImage} alt="" className="w-full h-full" />
            </figure>
            <article className="absolute w-[40rem] h-[24rem] z-10 top-[7rem] left-[30rem] flex flex-col justify-center px-12 py-12 bg-[#E9E6E0] text-red-800">
              <h2 className="text-4xl font-light italic mb-8">
